...
// BashTool — same as s02/s03. The only built-in tool we ship in s04.
// Real builds bring in read_file / web_search / glob / etc.; the Runner
// is agnostic to which tools the Registry holds.
