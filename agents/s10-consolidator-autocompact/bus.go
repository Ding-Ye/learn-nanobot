...
// Bus — same shape as s05/s06; carried over verbatim because each session is
// its own self-contained Go module. s07 doesn't change persistence or
// dispatch behavior — main.go just constructs an additional `SkillLoader`
// next to the `MemoryStore` and prints how many skills were loaded.
