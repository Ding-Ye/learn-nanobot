...
// Provider — same shape as s03/s04. Carried over verbatim because each
...
// Message stays the same as s01-s04 — a turn in the conversation.
type Message struct {
	Role    string         `json:"role"`
	Content []ContentBlock `json:"content"`
}

// ContentBlock — same shape as s01-s04.
