...
// Mirrors upstream `nanobot/agent/runner.py::AgentRunner`. UNCHANGED in
// s05 — the Bus just calls runner.Run from inside each session goroutine.
// See agents/s04-agent-runner/runner.go for the full design notes.
...
// MaxIterations. The signature is deliberately narrow.
