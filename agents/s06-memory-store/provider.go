...
// Provider — same shape as s03/s04/s05. Carried over verbatim because each
...
// Message stays the same as s01-s05 — a turn in the conversation.
type Message struct {
	Role    string         `json:"role"`
	Content []ContentBlock `json:"content"`
}

// ContentBlock — same shape as s01-s05.
